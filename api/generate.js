...
5. 把使用者提供的細節自然編織進場景，不要條列、不要複述問卷。使用者填的「最怕變成的樣子」只是眾多可能之一，不要預設它一定會發生、也不要每次都把場景寫成那個恐懼的實現；「最希望還留著的東西」同樣是線索，不是保證——它可以出現、可以以變形的方式出現、也可以在這個普通日子裡剛好沒被提起。
6. 可以讓讀者看到一個他隱約知道、卻還沒好好看見的東西——那個東西「不一定是問題」，也可能是一個他早就習慣、卻沒真正珍惜的好。
7. 誠實但不殘忍。結尾留一點餘地——那個餘地不一定是隱憂，也可以是一個溫暖的、還開著的可能。不要讓人讀完就沉下去，但也不要硬給一個廉價的圓滿。
